...
chrome.runtime.onInstalled.addListener(() => {
  ...
  chrome.storage.sync.get([
    ...
    "cat5PartialUSMX", 
    "cat6Outside",
    "cat7MagaDonor"   // new MAGA Donor category
  ], (data) => {
    ...
    if (!data.cat3US) {
      let cat3 = [
        ...
        "GOGO SQUEEZ",
        "AWAKE",
        "SMARTIES", // note that "SMARTIES" can also appear in CA version, but let's keep it
        "HARIBO",
        "JACK LINKS",
        "SLIM JIM",
        "GUSHERS",
      ...
      // remove "GREAT VALUE" explicitly from cat3
...
chrome.runtime.onMessage.addListener((req, sender, sendResponse) => {
  if (req.type === "updateBrands6") {
    chrome.storage.sync.set({
      ...
      cat7MagaDonor: req.cat7MagaDonor
